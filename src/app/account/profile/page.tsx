              ...
              <form className="max-w-2xl space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#1A1A1A]">Họ và tên</label>
                    <Input type="text" placeholder="Nhập họ và tên" className="h-11" defaultValue="Khách hàng" />
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#1A1A1A]">Số điện thoại</label>
                    <Input type="tel" placeholder="Nhập số điện thoại" className="h-11" />
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#1A1A1A]">Email</label>
                    <Input type="email" placeholder="Nhập email" className="h-11" />
                  </div>
                  
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#1A1A1A]">Ngày sinh</label>
                    <Input type="date" className="h-11" />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-semibold text-[#1A1A1A] block">Giới tính</label>
                  <div className="flex gap-6 mt-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="gender" value="male" className="w-4 h-4 text-[#FCCE00] focus:ring-[#FCCE00]" />
                      <span className="text-sm text-[#1A1A1A]">Nam</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="gender" value="female" className="w-4 h-4 text-[#FCCE00] focus:ring-[#FCCE00]" />
                      <span className="text-sm text-[#1A1A1A]">Nữ</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="gender" value="other" className="w-4 h-4 text-[#FCCE00] focus:ring-[#FCCE00]" />
                      <span className="text-sm text-[#1A1A1A]">Khác</span>
                    </label>
                  </div>
                </div>
