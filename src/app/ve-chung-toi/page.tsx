      ...
      <section className="relative overflow-hidden bg-[#530000] text-white">
        ...
        <div className="yody-container relative z-10 py-28 md:py-36">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05] mb-8 text-white">
              {isEn ? "About Us" : "Về Chúng Tôi"}
            </h1>
            <p className="text-white/90 text-base md:text-xl font-light leading-relaxed max-w-2xl border-l-2 border-white/40 pl-6">
              {isEn
      ...
      <section id="gioi-thieu" className="py-20 md:py-28 yody-container scroll-mt-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-6">
            <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#530000]">
              {isEn ? "Company Profile" : "Giới thiệu doanh nghiệp"}
            </span>
            <h2 className="text-3xl md:text-5xl font-black tracking-tight leading-tight text-neutral-900">
              {isEn ? "Where heritage meets the future" : "Nơi di sản gặp tương lai"}
            </h2>
            <div className="flex flex-wrap gap-3 pt-2">
              <Link
                href="/vieco-tech"
                className="inline-flex items-center justify-center px-6 py-3 text-sm font-bold bg-[#530000] text-white hover:bg-[#3d0000] transition-colors rounded-lg shadow-sm"
              >
                {isEn ? "Vie'Co Tech →" : "Vie'Co Tech →"}
              </Link>
              <Link
                href="/products"
                className="inline-flex items-center justify-center px-6 py-3 text-sm font-bold border-2 border-[#530000] text-[#530000] hover:bg-[#530000]/5 transition-colors rounded-lg"
              >
          ...
          <div className="lg:col-span-7 space-y-6 text-neutral-600 text-base md:text-lg leading-relaxed">
            ...
            <div className="relative aspect-[16/10] overflow-hidden bg-neutral-100 rounded-2xl shadow-md mt-4 border border-neutral-100 group">
              <img
                src="/images/ve-chung-toi.jpg"
                alt={isEn ? "Vie'Co fashion - About Us" : "Thời trang Vie'Co - Về Chúng Tôi"}
        ...
        <div className="yody-container py-20 md:py-28 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/20 border border-white/20 rounded-2xl overflow-hidden bg-black/10 backdrop-blur-sm">
            <div className="p-10 md:p-14 space-y-6">
              <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-red-200/80">
        ...
        <div className="yody-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-neutral-200 border border-neutral-200 rounded-2xl overflow-hidden">
            {values.map((v, i) => (
              <div
                key={v.num}
                className={`group bg-white p-8 md:p-10 hover:bg-[#530000] hover:text-white transition-colors duration-500 ${
              ...
              >
                <div className={i === 4 ? "space-y-5" : "space-y-5 h-full flex flex-col"}>
                  <div className="flex items-start justify-between gap-4">
                    <span className="text-4xl md:text-5xl font-black text-neutral-200 group-hover:text-white/20 transition-colors tabular-nums">
                      {v.num}
                    </span>
                    <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#530000] group-hover:text-red-200/80 transition-colors pt-2">
                      {v.subtitle}
                    </span>
                  </div>
                  <h4 className="text-xl md:text-2xl font-bold tracking-tight text-neutral-900 group-hover:text-white transition-colors">
                    {v.title}
                  </h4>
                  <p className="text-neutral-500 group-hover:text-white/90 text-sm md:text-base leading-relaxed transition-colors">
                    {v.desc}
                  </p>
                </div>
              </div>
